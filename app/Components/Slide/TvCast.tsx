...
import { getCastTv } from '@/Components/Server/ServerComponent';
import {TvPeople} from '@/page'
...
const TvCast = ( { id }: CastProps ) =>{

    const[peopleData, setPeople] = useState<TvPeople[]>([])
    ...
    useEffect(() => {
        ...
        const FetchCast = async() => {
            ...
            const data = await getCastTv(Number(id))
            setPeople(data);
